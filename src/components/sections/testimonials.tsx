      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        {!loading && !error && testimonials.length === 0 && (
          <div className="flex flex-col items-center justify-center py-12 md:py-16 lg:py-20 text-center">
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-[#d4a24c]/10 flex items-center justify-center mb-6">
              <Star className="w-6 h-6 md:w-8 md:h-8 text-[#d4a24c]" />
            </div>

            <h3 className={`${playfair.className} text-xl md:text-2xl font-semibold mb-2`}>No Reviews Yet</h3>
