...
export async function POST(request: NextRequest) {
    try {
        ...
        const message = body.message || `Hello ${name},\n\nYour reservation for ${guests} guest(s) on ${date} at ${time} has been received. We will follow up with confirmation details shortly.`
              ...
              <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); overflow: hidden;">
                <tr>
                  <td style="background: linear-gradient(135deg, #f97316 0%, #ef4444 100%); padding: 40px 30px; text-align: center;">
                    <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: bold;">Reservation Confirmation</h1>
                    <p style="margin: 10px 0 0 0; color: #ffffff; font-size: 14px; opacity: 0.9;">Thank you for choosing our restaurant.</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 40px 30px;">
                    ...
                    <table role="presentation" style="width: 100%; margin-top: 25px; border-collapse: collapse;">            
                      <tr>
                        <td style="padding: 12px 0; font-weight: 700; color: #374151; width: 30%;">Reservation Date</td>
                        <td style="padding: 12px 0; color: #111827;">${date}</td>
                      </tr>
                      <tr>
                        <td style="padding: 12px 0; font-weight: 700; color: #374151;">Reservation Time</td>
                        <td style="padding: 12px 0; color: #111827;">${time}</td>
                      </tr>
                      <tr>
                        <td style="padding: 12px 0; font-weight: 700; color: #374151;">Guests</td>
                        <td style="padding: 12px 0; color: #111827;">${guests}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
                <tr>
                  <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                    ...
                    <p style="margin: 0; color: #9ca3af; font-size: 12px;">© ${new Date().getFullYear()} Izakaya Tori Ichizu. All rights reserved.</p>
                  </td>
                </tr>
              </table>
            </td>
